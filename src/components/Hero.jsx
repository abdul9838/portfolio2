...
const Hero = () => {
    ...
    return (
        <div>
            <div className="flex flex-col items-start space-y-5 mt-12 md:space-y-7 md:px-5">
                <h1 className="text-4xl font-semibold">
                    Hey, I'm Abdul Ahad. <br />{' '}
                </h1>
                <h2 className="text-3xl">
                    I build websites with a focus on responsive design and accessibility.
                </h2>
                <p className="text-xl">
                    I'm a React JS Front End Developer - Builds user interfaces with React and related technologies. <br /> Find me on{' '}
                    <a
                    ...
                    <a
                        href="tel:+919838848691"
                        className={`${iconStyle}, hover:text-phone`}
                        aria-label="Follow me on LinkedIn"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
